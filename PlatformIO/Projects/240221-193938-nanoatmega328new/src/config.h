...
//#define DISABLE_RUDDER_SENSE  // if no rudder sense Hans
...
/*
  #define RUDDER_MIN 32767 // The minimum value at which RUDDER_MIN flag is being set
  #define RUDDER_MAX 32767 // The maximum value at which RUDDER_MAX flag is being set
  #define RUDDER_MIN_ADC 32767 // Your actual minimum sensor value
  #define RUDDER_MAX_ADC 32767 // Your actual maximum sensor value. These two must be configured to your setup to work properly
*/
...
#define THERMISTORNOMINAL 5000 // 100k thermistor
// temp. for nominal resistance (almost always 25 C)
#define TEMPERATURENOMINAL 20
// The beta coefficient of the thermistor (usually 3000-4000)
#define BCOEFFICIENT 3950
// the value of the 'other' resistor
#define SERIESRESISTOR 22000 // 4.7k resistor
