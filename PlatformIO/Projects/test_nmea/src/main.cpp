...
#define N2k_SPI_CS_PIN 9    // If you use mcp_can and CS pin is not 53, uncomment this and modify definition to match your CS pin.
#define N2k_CAN_INT_PIN 2   // If you use mcp_can and interrupt pin is not 21, uncomment this and modify definition to match your interrupt pin.
